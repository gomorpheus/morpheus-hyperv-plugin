 ...
 */
	...
	Collection<OptionType> getNodeOptionTypes() {
		...
		nodeOptions << new OptionType(
				name: 'mount logs',
				category: "provisionType.hyperv.custom",
				code: 'provisionType.hyperv.custom.containerType.mountLogs',
				fieldContext: 'domain',
				fieldName: 'mountLogs',
		...
		nodeOptions << new OptionType(
				name: 'mount config',
				category: "provisionType.hyperv.custom",
				code: 'provisionType.hyperv.custom.containerType.mountConfig',
				fieldContext: 'domain',
		...
		nodeOptions << new OptionType(
				name: 'mount data',
				category: "provisionType.hyperv.custom",
				code: 'provisionType.hyperv.custom.containerType.mountData',
				fieldContext: 'domain',
				fieldName: 'mountData',
